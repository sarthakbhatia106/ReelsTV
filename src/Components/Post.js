              ...
              <React.Fragment key={post.postId}>
                <div className='videos'>
                  ...
                  <div className='fa' style={{ display: 'flex' }}>
                    <Avatar className='avatar' src={post.uProfile}></Avatar>
                    <h4>{post.uName}</h4>
                  </div>
                    ...
                    <MuiDialogContent>
                      <div className='dcontainer'>
                        <div className='video-part'>
                          <video autoPlay={true} className='video-styles2' id={post.id} muted="muted" type="video/mp4" >
                        ...
                        <div className='info-part'>
                          ...
                          <div className='extra'>
                            <div className='likes'>
                              <Typography className={classes.typo} variant='body2'>Liked By {post.likes.length == 0 ? 'nobody' : `${post.likes.length} others`}</Typography>
                            </div>
